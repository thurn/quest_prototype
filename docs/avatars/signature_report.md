# Avatar Signature Card Report

This report traces every Avatar's signature cards from the moment signatures
...
`70a4f6ad` (2026-06-04), which gave **20 of the 32 Avatars** a fixed list
...
1. **From shared staples to bespoke packages.** The original lists leaned on a
   ...
   Reflections* anchored almost every event Avatar; *Dreadweaver*, *Skull
   ...
   *Celestial Reverie* and *Mountainwatch Alpha* recurred across the character/
   spirit-animal callers. The current lists are largely unique per Avatar and
   built to feed each one's specific ability.
2. **From uniform-5 to variable counts.** Every signed Avatar started with
...
Only one Avatar — **Yveth Coravel** — kept her entire original signature set.

---

# Avatars with signature cards
...
**What changed:** Kept 0, removed 5, added 3 (5 → 3) — the only signed Avatar
...
Avatar from "incoherent goodstuff" to "laser-focused tribal payoff," accepting
...
**What changed:** Kept 5, removed 0, added 0 (5 → 5). **The only Avatar whose
...
# Avatars without signature cards

These twelve Avatars were never assigned signature cards — neither at the
...
| Avatar | Original count | Current count | Kept | Removed | Added |
| --- | --- | --- | --- | --- | --- |
| Kell Tarn | 5 | 6 | 1 | 4 | 5 |
| Caedryn | 5 | 5 | 0 | 5 | 5 |
| Kragg | 5 | 6 | 0 | 5 | 6 |
...
- The dominant design direction was **alignment**: most Avatars traded
