# Dreamtides — Core Cards by Archetype

A companion to [dreamtides_archetypes.md](dreamtides_archetypes.md). Where
[dreamtides_archetype_cards.md](dreamtides_archetype_cards.md) lists *every* card
connected to an archetype, this document picks only the **core** cards: the 1–4
cards that most uniquely define what each archetype is trying to do. Smaller
archetypes get one or two; the broadest get four.

Each card appears under exactly one archetype — its home, where it is most
defining — even when it sees play across several decks. Each entry gives the
card's cost, type, and spark, its full rules text, and a note on why it defines
the archetype. Archetypes follow the order in `dreamtides_archetypes.md`.
...
*3● Character — Spirit Animal, 4✦*

> ❖ – 5●: Allied spirit animals gain +3✦ and vengeful until end of turn.
...
*1● Character — Outsider, 1✦*

> ▸Materialized: Return another ally to hand. Move this character to that ally’s position.
> When this character scores ⍟, draw a card, then discard a card.
...
> ▸Materialized: Return another ally to hand. Move this character to that ally’s position.
> When an allied outsider scores ⍟, foresee 1, then draw a card.
...
> The first warrior you play each turn costs 3● less.
...
> Support – Supported characters have +1✦ for each allied warrior.
...
*2● Character — Visitor, 1✦*

> When you play an event, materialize a 1✦ ethereal figment.
...
> When you play an event, store 1⧗.
> 5⧗: Return all other characters to hand.
...
> Veil 3●
> When an ally is dissolved, materialize a 1✦ survivor figment.
...
> Erode 4. You may put two of those cards into your hand.
...
> Abandon a character: Store 1⧗.
> X⧗: Dissolve an enemy with X✦.
...
*4● Character — Tinkerer, 3✦*

> You may play characters with cost 2● or less from your void.
...
*6● Character — Explorer, 8✦*

> ▸Dawn: Abandon a character. Erode 1.
...
> Gain 2⍟ for each card you have played this turn.
...
> For each card you've played this turn, materialize a 1✦ ember figment with awakened.
> Reclaim 2●
...
> Until end of turn, when you materialize a character, draw a card.
> Reclaim 4●.
...
*4● Character — Warrior, 3✦*

> Abandon a warrior: Gain 2●.
...
> To play this event, abandon a warrior.
> Discover a warrior with higher cost, then materialize it.
...
> Materialize all characters in your void which dissolved this turn.
...
> Materialize all characters with cost 2● or less in your void which dissolved this turn.
...
> Until end of turn, when an ally is dissolved, return it to your hand.
...
*4● Character — Monster, 2✦*

> When you materialize a character, awaken each other allied character.
...
> When you play an event, awaken each allied character.
