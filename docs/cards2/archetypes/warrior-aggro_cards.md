...
A companion to [warrior-aggro.md](warrior-aggro.md), listing every CardsV2 card with a specific affinity for the Warrior Aggro archetype — the cards you would prioritize drafting when building this deck. Cards are drawn from `data/tabula/cards_v2.toml`.
...
9. Sandglider — 0● fast vanilla warrior; free body for the count and an early front-rank attacker.
10. Aspiring Guardian — 0● 1✦ vanilla warrior; free body that pads the warrior count.
11. Pyre Challenger — 1● Awakened warrior, "▸Challenge: This character gains +1✦"; cheap body that hits as a growing attacker.
12. Saffron Trailblazer — 1● Awakened warrior with a reposition ❖; cheap evasive body for the front rank.
13. Dawnblade Wanderer — 1● 2✦ warrior, "when you materialize a character, gain 1●"; aggressive body that helps refund deployment.
14. Meadowlight Charger — 1● 2✦ warrior that amplifies ✦ gains and pumps an ally; aggressive body that boosts the anthem plan.
...
24. Field Reverent — "X●: Each allied character's ✦ becomes X until end of turn"; convert leftover energy into a board-wide swing.

## One-shot reach and finishers

25. Shadow Reflection — 1● event, "Give an ally +1✦ for each allied warrior"; Cranial-Plating burst on one front-rank attacker.
26. Ironclad Holdout — 1● warrior, "▸Challenge: Each challenging ally gains +1✦"; Signal-Pest pump for a coordinated front rank.
27. Flamestride Rider — "Allied warriors cannot be dissolved while challenging"; blockers trade nothing and your warriors keep coming.
...
37. Spellweaver — "1●, Abandon a non-figment warrior: Materialize a 1✦ warrior figment"; recycles a spent body into a fresh figment.
...
## Card flow that keeps the assault going

45. Invoker of Myths — "Once per turn, when you materialize a warrior, draw a card"; refills as you deploy, the deck's main draw engine.
46. Spent Courier — "▸Materialized, Dissolved: Draw a card with ephemeral"; cheap warrior that cantrips on both ends.
47. Ossuary Overlord — "▸Materialized, Dissolved: Draw a card"; the durable cantrip warrior that replaces itself.
48. Crucible Warlord — "▸Materialized: Draw a warrior"; a 3✦ body that digs to the next threat.
49. Frost Visionary — 2● warrior, "▸Materialized: Draw a card"; cheap warrior body that replaces itself.
50. Key to the Moment — "Return all but one allied character to hand. Draw a card for each"; Paradoxical-Outcome refuel that re-fires ▸Materialized triggers.
51. Scorched Crusader — stores ⧗ on materializing non-figments, then "3⧗: Return a warrior from your void to your hand"; warrior recursion engine.
52. Thundercatcher — "2●, Abandon a 1✦ ally: Draw 2 cards"; cashes a spent figment or cheap warrior into cards.
53. Sigil Analyst — 5● warrior, "▸Materialized: Draw 2 cards"; top-end refill body that stays on-tribe.
...
61. Tranquil Duelist — Vengeful, "▸Dissolved: Return another warrior from your void to your hand"; a body that buys back a warrior when it trades.
62. Starbound Striker — "▸Dissolved: Return another warrior from your void to your hand"; cheap warrior that recurs on trade.
...
67. Enginespeaker — "This character has all character types"; counts as a warrior for every payoff at a cheap rate.
68. Sky Voyager — 1● "all character types" body with ▸Dawn ramp; a warrior for the count plus energy.
69. Signal Resonant — 1● "all character types" body with a reposition; flexible warrior for anthems and Support.
70. Boundless Wanderer — "all character types" and can grant the team all types; turns the board into warriors for a payoff turn.
71. Voidcaller — "▸Materialized: Banish an enemy warrior"; tribal removal that clears mirror blockers (and is on-color).
72. Summons of the Bonded — fast event, "Dissolve an enemy warrior"; cheap tribal removal for the mirror.
73. Fury of the Clan — "Play only with 3 allied warriors. Dissolve an enemy"; cheap unconditional removal the wide board unlocks.

## Marginal but archetype-relevant

74. Vault Infiltrator — "Players may only play one card per turn"; symmetric tax for a leaner prison-leaning warrior build.
75. Sorrowful Prince — "X●: This character gains +X✦ until end of turn"; a warrior body that converts surplus energy into reach.
