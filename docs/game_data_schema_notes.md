...
Augury encounter composition, offer mechanics, and player-facing offer copy.
Each archetype carries an internal debugging name and authored headline and
subtitle presentation beside its tuning. Archetype ids are stable code
contracts; designers can enable, tune, and present an archetype here without
editing TypeScript or Fluent resources.
...
knobs, enabled state, and player-facing presentation.
