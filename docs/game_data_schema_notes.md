...
Augury encounter composition and offer mechanics. Each archetype carries an
internal debugging name and a concise behavioral description beside its tuning.
Archetype ids are stable code contracts; designers can enable and tune an
archetype here without editing TypeScript.
