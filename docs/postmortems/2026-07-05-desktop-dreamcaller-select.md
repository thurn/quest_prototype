# Postmortem: Desktop Dreamcaller Select design process
...
Getting the desktop Dreamcaller select to a good state took **~15 hours of
...
- Abandoned redesign worktrees `.worktrees/dreamcaller-desktop-redesign{,-2}`
  still exist, and `wt/dreamcaller-desktop-redesign-2` was pushed to `origin`.
