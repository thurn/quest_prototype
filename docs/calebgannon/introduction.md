...
[](https://i0.wp.com/calebgannon.com/wp-content/uploads/2022/03/good_pick.jpg?ssl=1)A real pick I made in a real draft. (With an outdated cube list).
...
The image above is an example of a moment where that happened to me, and I posted the picture in [my discord](https://discord.gg/EM7jZx8RC7) where people made plenty of jokes about me passing sol ring for a random worthless 1/1 (in jest, of course). 
...
[](https://i0.wp.com/calebgannon.com/wp-content/uploads/2022/03/unknown-1.png?ssl=1)The final deck that came together after I picked up the shrieking drake (with an older cube list).
