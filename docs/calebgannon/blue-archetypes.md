# Blue Archetypes in My Powered Synergy Cube

*Source: https://calebgannon.com/2022/04/22/blue-archetypes-in-my-powered-synergy-cube/*
...
Now I’m sure many of you might be confused by this. “Why are we talking about removal and stuff in the section that is supposed to be about ninjas”. The reason is that the Ninjas deck is secretly just a great medium to take advantage of cheap interaction. So in reality, the interaction is what makes the deck and the Ninjas are only secondary. At least in this cube, Ninjas plays a lot more tempo-control than it does full combo. The Ninja synergies are great and fun, but they absolutely will not work if you don’t back them up with some way to stop your opponent from killing your creatures or comboing you out. You can think of it like Legacy Delver of Secrets. 

You can have a great UB tempo deck without Ninjas, but you really cannot have a great Ninjas deck without the interactive cards. Plus, there are tons of archetypes fighting over the removal, discard and countermagic but there should be much less competition for the Ninjas and enablers themselves. All this is to say: _make sure you have a solid base of disruptive cards to support and protect your tempo creatures_.
...
In these decks, the free/cheap spells are absolutely vitial since you are trying to establish a lead early. Keeping your early creature alive and clearing a path for them to hit is critical to your chances of success. Overall I would say this strategy is the most similar to what people think of when they hear of a Ninjas archetype. 

Tempo plays become extra valuable here, with things like Snap and Remand able to set your opponent so far behind they won’t be able to come back, especially since you’re drawing a reasonable number of extra cards per turn!
...
You can sometimes get into races where flying threats like the above three can be useful. Fliers that hit for 3+ kill a lot faster than most people realize. Unfortunately for whatever reason Occult Epiphany is not on MTGO so you can only look for that card in my paper cube. 
...
In my cube, Tinker plays out like Demonic Tutor for artifacts, but in a way that lets you still cheat on mana and put things like Lotus Bloom into play. I realize that initially it will feel like a bad card, but that is only relative to the usual mode of 3 mana win the game that it normally is. Tinker is still very useful in this cube, but you just need to temper your expectations and treat it like a tutor. Finding Thopter Foundry, Scrap Trawler and Krark-Clan Ironworks are all incredibly useful applications of this card in combo oriented builds. 

In more aggressive decks you can still Tinker up some of the key payoff cards like Nettlecyst, Lodestone Golem or even Ethersworn Canonist. These modes are all quite good, once you know what you should be expecting. 

TLDR: Probably don’t first pick Tinker in this cube, but also don’t completely ignore it. The card is good, it just serves a different role than you might be accustomed to. Crop Rotation is a reasonable comparison for it. The best use for Tinker is probably in setting up Second Sunrise loops by Tinkering for something like Lotus Bloom or KCI.
...
Lastly, its worth mentioning that Jeskai Ascendancy doesn’t always have to be a storm card. Repeatable loots and untaps can be good enough on their own. Swing with your army, then cast Ponder to untap everything so you’re ready to block. Or combine it with Glint-Horn Buccaneer to ping your opponent to death in a discard deck. The common loots can let you go off with dredge too, making cards like Life from the Loam crazy strong as you are guaranteed to have a constant stream of spells. Loam in particular can help you set up for a win with Conflagrate or Thassa's Oracle.

There are so many ways to take advantage of both of these cards, what I’ve named is only scratching the surface of what you can do. I recently had a Hogaak Madness Ascendancy list that was particularly spicy, and a lot of what I’m discussing here is just a result of things that I have seen people using the cards for. A lot of this stuff I didn’t even plan for originally, so don’t be scared to get creative.
...
The rules are as follows: 
  ...
  * I must receive picture evidence of the crab-related deaths.
  * The Hard Evidence Crab must be the cause of lethal. 
  * Other cards with creature type Crab don’t count, but they do add. (Mirror Entity can turn your team into crabs, for example). You need at least one Hard Evidence Crab in there. The more naturally occurring crabs, the better like Changeling Outcast.
  * Infinite will be counted as 1000 damage per Crab token Dealing Damage.
  * Creativity points will decide most of this. If you do something completely different than what I have described here, that will be a huge bonus. I don’t know if it is possible, but non combat based crab lethal would be awesome.
  * Send them to me on twitter @calebgannonmtg
  * This is mostly for the fun if it, so have fun! I may give out prizes if I see wins that are spectacular enough though.



(I’ll probably fill in this section more later, or write a separate article describing how to draft storm in vintage cube, but for now just watch my videos haha).
