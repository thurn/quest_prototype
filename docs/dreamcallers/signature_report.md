# Dreamcaller Signature Card Report

This report traces every Dreamcaller's signature cards from the moment signatures
...
original `dreamcallers.toml` (which used legacy tide metadata) nor in the first
version of `dreamcallers_v2.toml`. They were first added in commit `70a4f6ad`
*("Standardize on idf3: move pool metadata between toml and TypeScript",
2026-06-04)*, which gave **20 of the 32 Dreamcallers** a fixed list of **five
...
1. **From shared staples to bespoke packages.** The original lists leaned on a
   ...
   Reflections* anchored almost every event Dreamcaller; *Dreadweaver*, *Skull
   ...
   *Celestial Reverie* and *Mountainwatch Alpha* recurred across the character/
   spirit-animal callers. The current lists are largely unique per Dreamcaller and
   built to feed each one's specific ability.
2. **From uniform-5 to variable counts.** Every signed Dreamcaller started with
...
Only one Dreamcaller — **Yveth Coravel** — kept her entire original signature set.

---

# Dreamcallers with signature cards
...
**What changed:** Kept 0, removed 5, added 3 (5 → 3) — the only signed Dreamcaller
...
Dreamcaller from "incoherent goodstuff" to "laser-focused tribal payoff," accepting
...
**What changed:** Kept 5, removed 0, added 0 (5 → 5). **The only Dreamcaller whose
...
# Dreamcallers without signature cards

These twelve Dreamcallers were never assigned signature cards — neither at the
...
| Dreamcaller | Original count | Current count | Kept | Removed | Added |
| --- | --- | --- | --- | --- | --- |
| Kell Tarn | 5 | 6 | 1 | 4 | 5 |
| Caedryn | 5 | 5 | 0 | 5 | 5 |
| Kragg | 5 | 6 | 0 | 5 | 6 |
...
- The dominant design direction was **alignment**: most Dreamcallers traded
