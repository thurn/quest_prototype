...
A Bane is a special card that a player can acquire during a Journey, typically as
a result of a [Dream Journey](journeys.md#dream-journey). Bane cards typically
have a negative effect while in the player's hand, or when draw. Bane cards are
not events or characters, but they do have an energy cost and can be played
normally. Banes always have the effect of making the player draw a card when
played, so they can always be removed eventually by paying their energy cost.

The "Nightmare" bane is the default for effects, with the others working in more
specialized roles.

## List of Banes

- Nightmare. 2 energy. Draw a card.
- Despair. 1 energy. When drawn, lose 1 point. Draw a card.
