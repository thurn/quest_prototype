...
A Dream Journey in Dreamtides is a random effect that modifies a journey in some
...
journeys should ever face the same choices. In order to achieve this, journeys are
...
- Conditions/Triggers: Some effects give the player a “mini journey” to complete
...
- Statuses: Dream journeys are able to create ongoing changes to the journey
...
are curated in a fun way, while still having variance between journeys. This needs
...
kind of neutral or negative effect is represented by a “journey status effect”, a
...
- Gain a battle/journey tradeoff, e.g. a powerful battle effect that depletes your
...
A status allows the dream journey to apply a persistent mutation to the journey.
...
- For the rest of the journey, you draft only from a refilling pool of 50 cards
...
- Pairing major journey effects with major rewards, like “you can no longer gain
