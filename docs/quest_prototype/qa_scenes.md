...
| `tutorial-dream-avatar-select`   | Tutorial Dream Avatar selection with only `BFC40414-5264-41BF-86E1-A0F41EE4F5B5` shown, centered beside its three authored Valor tides; choosing it starts a quest with their 150-card pool                    |
