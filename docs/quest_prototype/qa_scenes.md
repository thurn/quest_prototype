...
| `tutorial-dream-avatar-select`   | Tutorial Dream Avatar selection with only `BFC40414-5264-41BF-86E1-A0F41EE4F5B5` shown, centered; choosing it starts an ordinary quest                                                                            |
