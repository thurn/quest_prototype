...
- [Quest Prototype](quest_prototype.md) explains the folded room-event
...
The primary [Quest Prototype](quest_prototype.md) document must be revised with
...
Inspect the battle log and quest log. Confirm they identify all cards and
