...
describe("toRepoRelativePosix (no-primitive-tokens)", () => {
  it("returns a clean repo-relative path", () => {
    expect(
      toRepoRelativePosix(
        "/Users/x/quest_prototype/src/tango/docs/mockups/scene.tsx",
        "/Users/x/quest_prototype",
      ),
    ).toBe("src/tango/docs/mockups/scene.tsx");
  });
});
...
ruleTester.run("no-primitive-tokens", rule, {
  valid: [
    ...
    },
    {
      ...
      filename: "src/tango/docs/PrimitivesSection.tsx",
  ...
  invalid: [
    ...
    },
    {
      ...
      filename: "src/tango/docs/demos/button.tsx",
