...
const rule = {
  meta: {
    ...
    docs: {
      description:
        "Require complete Trox messages for count-dependent player copy.",
    },
    schema: [],
    messages: {
      manualCountCopy:
        "Count-dependent player copy must be a complete Trox message with a numeric selector; pass the count as semantic data.",
    },
  },
