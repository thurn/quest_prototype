...
const NAMED_REVEAL_COMPONENTS = new Set(["GameCard", "CompactGameCardRow", "EntityReference", "InfoCard", "AtlasNode", "GlossaryTerm", "BattleGameCard", "Dreamsign", "WagerPrizeCard", "DreamAvatarPortrait", "DreamAvatarAbilityText", "TideDisc", "TidesInfoLabel", "ResourceChip", "PipBadge", "CardStatOrb", "JourneyStatusBar", "SiteNode", "TransfigurationFormButton", "OfferTile"]);
