...
ruleTester.run("no-external-ui-imports", rule, {
  valid: [
    {
      name: "cumulus-internal relative import",
    ...
    },
    {
      ...
      filename: "src/cumulus/docs/demos/x.tsx",
    ...
    {
      name: "outside cumulus importing forbidden path: still inert",
      filename: "src/components/App.tsx",
    ...
    {
      name: "export * from cumulus-internal (ExportAllDeclaration)",
      filename: "src/cumulus/components/index.tsx",
