...
battle-zone-browser-filtered-count =
    { $visibleCount } of { $totalCount } { -card(number: "other") }
...
exploration-smaller-hand-cost-accessible-name = Your next battle begins with { $openingHandDelta } { $openingHandDelta ->
        [one] { -card(number: "one") }
...
exploration-opening-hand-change-announcement = { $openingHandDelta } { $openingHandDelta ->
        [one] { -card(number: "one") }
       *[other] { -card(number: "other") }
    }
