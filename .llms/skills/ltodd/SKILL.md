...
several-hundred-page book describing how the production game works and why its
major design decisions exist. An expert developer or implementation LLM
unfamiliar with this repository should be able to reimplement Dreamtides
correctly and with high confidence from the book and its companion TOML
catalogs.
