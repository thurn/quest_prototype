...
- `docs/journey_prototype/localization.md` for this repository's Fluent term
  model;
- the relevant portion of `data/tabula/strings.flt`;
...
Keep the English source in `data/tabula/strings.flt`. Add or extend a shared
