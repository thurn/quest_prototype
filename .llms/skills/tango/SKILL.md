...
| Card Gallery Panel | Components | 2 | [components/card-gallery-panel.md](components/card-gallery-panel.md) | The shared card-browser surface: a left-aligned title and subtitle, a trailing header accessory, and a scrolling GameCard grid, framed as floating glass or a full-bleed alpha scrim. |
