...
| Transfiguration Form Button | Components | 1 | [components/transfiguration-form-button.md](components/transfiguration-form-button.md) | The compact forge-form choice: a colored transfiguration glyph in a touch-sized square, with the form name, cost, and effect revealed through InfoCard. |
