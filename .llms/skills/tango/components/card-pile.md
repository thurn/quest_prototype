<!-- GENERATED by scripts/generate-tango-docs.mjs — do not edit by hand.
     ...
     entry in src/tango/docs/demos/card-pile.tsx. Regenerate: npm run tango-docs -->

# Card Pile

Components · Live demo & interactive props: `/tango#/card-pile`
...
```tsx
import { CardPile } from "src/tango/components/battle/CardPile";
