...
Real consumers: **24** (imports outside `src/tango/docs/` and tests).
...
Pressable measures the wrapped element so wide rows and compact controls move by a comparable physical distance. Mouse and pen hover upward, every primary press moves downward, and touch never hovers.
