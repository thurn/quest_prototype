...
Pressable adds the shared scale-down feedback and a pointer cursor to whatever it wraps. Pass the tag via `as`; extra HTML attributes (onClick, aria-*) forward to the rendered element.
