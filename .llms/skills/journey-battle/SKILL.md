---
name: journey-battle
description: Use when editing or testing battle mode in the journey prototype, including playable battle UI, battle debug tools, battle overlays, reward flow, and battle-specific browser QA. Triggers on journey battle, playable battle, battle prototype, battle UI, goto=battle, battle log, reward surface, side summary, battle inspector, or battle QA.
---
...
- battle UI in the journey prototype
...
This skill does not cover full journey-map progression except when needed to get
into a battle state.

## Runtime Basics

- The journey prototype is this repository (`~/quest_prototype/`).
- Battle mode is part of the journey prototype, not a separate app.
...
6. Run broader journey-prototype checks.
