...
| ---: | --- | --- | --- |
| 1 | Gain {essence} essence | standard | vertical slice required |
| 2 | Gain a random amount of essence between {essence1} and {essence2} | standard | vertical slice required |
...
| 8 | Purge up to {count} chosen {predicate} cards and gain a random {predicate} replacement for each card purged | standard | vertical slice required |
...
| 20 | Apply a transfiguration to {count} chosen {predicate} cards | standard | vertical slice required |
| 21 | Apply {transfiguration} to {count} chosen {predicate} cards | standard | vertical slice required |
| 22 | Apply a transfiguration to {count} random {predicate} cards | standard | vertical slice required |
| 23 | Apply {transfiguration} to {count} random {predicate} cards | standard | vertical slice required |
| 24 | Transfigure {count} random starter cards | standard | vertical slice required |
| 25 | Transfigure all starter cards | standard | vertical slice required |
| 27 | Gain {dreamsign_name} | standard | reuse `GainDreamsign` |
| 28 | Gain a random dreamsign | standard | reuse `GainRandomDreamsign` |
| 29 | Gain one of 3 offered dreamsigns | standard | vertical slice required |
| 30 | Replace a chosen dreamsign with one of 3 offered dreamsigns | standard | vertical slice required |
| 32 | Purge $STARTER_CARD | standard | vertical slice required |
| 33 | Purge a random starter card | standard | vertical slice required |
| 34 | Purge a random starter card and gain a {predicate} card | standard | vertical slice required |
| 35 | Purge all starter cards and replace each one with a {predicate} card | standard | vertical slice required |
...
| 40 | Transfigure all cards in your deck | unique_effect | vertical slice required |
| 41 | Add a duplication site to this dreamscape | standard | vertical slice required |
| 42 | Add a card market site to this dreamscape | standard | vertical slice required |
| 43 | Add a dreamsign bazaar site to this dreamscape | standard | vertical slice required |
| 44 | Add a transfiguration site to this dreamscape | standard | vertical slice required |
| 45 | Add a purge site to this dreamscape. | standard | vertical slice required |
| 46 | Choose one of three site types to add to this dreamscape. | standard | vertical slice required |
| 47 | Choose a card to purge and replace it with {card_id} | standard | reuse `ReplaceSelectedWithCard` |
| 48 | Purge a random {predicate} card and replace it with {card_id} | standard | vertical slice required |
...
| 63 | Replace all of your dreamsigns with random dreamsigns | standard | vertical slice required |
...
| 68 | Double your current essence. | standard | vertical slice required |
| 69 | Gain {count} Nightmare cards. Gain {dreamsign}. | standard | vertical slice required |
...
| 78 | Gain any number of {predicate} cards from 4 choices and apply {transfiguration} to each eligible card gained. Gain {count} Nightmare cards. | standard | vertical slice required |
...
| 80 | Select 4 random cards from your deck and choose one to purge. Apply {transfiguration} to the other 3 eligible cards, then gain a copy of each. | standard | vertical slice required |
...
| 82 | Lose half your current essence. The next {count} items you purchase are free. | standard | vertical slice required |
