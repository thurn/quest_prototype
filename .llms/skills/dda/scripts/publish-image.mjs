...
function usage() {
  return [
    "Usage: publish-image.mjs --file <image> --essay <essay> --slug <slug>",
    "  --alt <text> --caption <text> [--dry-run]",
    "",
    "Uploads one content-addressed DDA screenshot and prints its Markdown.",
  ].join("\n");
}
