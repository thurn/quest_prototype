...
| DreamAvatar Portrait | Components | 14 | [components/dream-avatar-portrait.md](components/dream-avatar-portrait.md) | The shared framed DreamAvatar profile surface: a square `panel` crop for profile cards and popovers, or a close `thumb` crop for HUD rows and resident lists. |
...
| Rich Text | Components | 11 | [components/rich-text.md](components/rich-text.md) | The design system's model for formatted copy. |
