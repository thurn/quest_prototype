...
| Dreamcaller Ability Text | Components | 2 | [components/dreamcaller-ability-text.md](components/dreamcaller-ability-text.md) | The complete Dreamcaller rules-text source: hovering, focusing, or touch-holding anywhere in the ability reveals one compact title-free card containing every defined term in reading order, using Dreamcaller-specific exhaust guidance. |
