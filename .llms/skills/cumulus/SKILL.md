...
| Banished Zone Indicator | Components | 1 | [components/banished-zone-indicator.md](components/banished-zone-indicator.md) | A rounded symbolic portal for a non-empty banished zone, using fixed ethereal art instead of any card in the zone. |
