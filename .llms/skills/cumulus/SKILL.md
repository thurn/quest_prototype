...
| Glass Panel | Components | 7 | [components/glass-panel.md](components/glass-panel.md) | The shared liquid-glass content container: an optional structured header, a composed body, and an optional footer on the canonical floating material. |
...
| Corner Utility Menu | Components | 0 | [components/corner-utility-menu.md](components/corner-utility-menu.md) | The strict app-chrome command offering: a fixed icon trigger and a hierarchical inward-opening utility menu. |
| Context Action Menu | Components | 0 | [components/context-action-menu.md](components/context-action-menu.md) | The strict pointer/card command offering: a clamped desktop context menu and a responsive dialog sheet with the same typed hierarchy. |
