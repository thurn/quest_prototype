...
| Dreamcaller Ability Text | Components | 2 | [components/dreamcaller-ability-text.md](components/dreamcaller-ability-text.md) | The complete Dreamcaller rules-text source: hovering, focusing, or touch-holding anywhere in the ability reveals one compact Rules Glossary card containing every defined term in reading order. |
...
| Card Term Definitions | Components | 0 | [components/card-term-definitions.md](components/card-term-definitions.md) | An incubating compact Rules Glossary card containing every gameplay term in a stretch of rules text. |
