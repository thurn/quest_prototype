...
| Offer Tile | Components | 2 | [components/offer-tile.md](components/offer-tile.md) | The circular symbolic Dream Augury offer button in named 300×300 desktop and 240×240 mobile sizes: UUID-backed complete cards, dreamsign art, and operation marks gathered over a flat-black interior inside the gold-and-feather frame without spelling out the complete offer. |
