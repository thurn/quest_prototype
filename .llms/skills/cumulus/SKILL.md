...
| Glass Panel | Components | 11 | [components/glass-panel.md](components/glass-panel.md) | The shared liquid-glass content container: an optional structured header, a composed body, and an optional footer on the canonical floating material. |
...
| Character Dialogue | Components | 3 | [components/character-dialogue.md](components/character-dialogue.md) | A character portrait in the canonical round frame, paired with SpeechBubble and presented as one fadeable guide-dialogue object in compact, wide, or prominent scale. |
