...
| Playing Card | Components | 1 | [components/playing-card.md](components/playing-card.md) | The standard rank-and-suit object: an Impact index and a fitted 4×4 checkerboard back on a quartic-superellipse square made from the shared liquid glass. |
