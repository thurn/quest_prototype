...
| --- | --- | --- | --- | --- |
| Pressable | Primitives | 26 | [components/pressable.md](components/pressable.md) | The one press-feedback primitive. |
...
| Dreamcaller Portrait | Components | 16 | [components/dreamcaller-portrait.md](components/dreamcaller-portrait.md) | The shared framed and stage-filling Dreamcaller art surface: the transparent full-body cutout in one of six fixed framings. |
