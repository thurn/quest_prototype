...
| Card Choice Grid | Components | 2 | [components/card-choice-grid.md](components/card-choice-grid.md) | A frameless, responsive grid for presenting resolved GameCards as choices inside an existing site or panel surface. |
