...
| Card Gallery Panel | Components | 5 | [components/card-gallery-panel.md](components/card-gallery-panel.md) | The shared card-browser surface: a left-aligned title and subtitle, optional header and centered footer actions, and a scrolling GameCard grid, framed as floating glass or a full-bleed alpha scrim. |
