...
| Offer Tile | Components | 1 | [components/offer-tile.md](components/offer-tile.md) | The 200×200 rounded symbolic Dream Augury offer button: UUID-backed card art, dreamsign art, and operation marks gathered inside a selectable fantasy frame without spelling out the complete offer. |
