...
| Offer Tile | Components | 2 | [components/offer-tile.md](components/offer-tile.md) | The circular symbolic Dream Augury offer button in named 300×300 desktop and 240×240 mobile sizes: UUID-backed full-bleed card art, Dreamsigns over authored full-art fields, and centered operation marks inside the gold-and-feather frame. |
