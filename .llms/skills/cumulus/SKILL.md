...
| Character Dialogue | Components | 1 | [components/character-dialogue.md](components/character-dialogue.md) | A compact character portrait in the canonical round frame, paired with SpeechBubble and presented as one fadeable guide-dialogue object. |
