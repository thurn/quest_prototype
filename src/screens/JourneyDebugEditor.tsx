...
export default function JourneyDebugEditor({
  isOpen,
  onClose,
}: {
  isOpen: boolean;
    ...
    <JourneyDebugEditorScreen
      ...
      onAddDreamsign={(id) => {
        ...
        if (template !== undefined)
          mutations.addDreamsign({ ...template }, SOURCE);
      }}
      ...
      onSetTransfiguration={(entryId, type) =>
        mutations.transfigureCard(
          entryId,
          type,
          "journey_debug_editor:transfigure",
          {},
        )
      }
      onSetTypeChange={(entryId, typeChange) =>
        mutations.setDeckEntryTypeChange?.(entryId, typeChange, SOURCE)
      }
      onSetKeywords={(entryId, keywords) =>
        mutations.setDeckEntryKeywords?.(entryId, keywords, SOURCE)
      }
    />
  );
}
