// Adapter bridging live quest state to the pure Tango atlas screen
// (`src/tango/screens/AtlasScreen`). Adapters are wiring only: this one owns
...
// (`atlas-view-model.ts`); the Tango screen itself stays pure. The atlas's
