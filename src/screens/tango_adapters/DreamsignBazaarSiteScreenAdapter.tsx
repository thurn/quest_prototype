// Adapter for Amunet's Tango Dreamsign Bazaar. Wiring only.

import { useCallback, useEffect, useMemo, useRef, useState } from "react";
import { logEvent, logEventOnce } from "../../logging";
import { useQuest } from "../../state/quest-context";
import { requireDreamsignId } from "../../data/dreamsigns";
import { DreamsignBazaarSiteScreen } from "../../tango/screens/DreamsignBazaarSiteScreen";
import {
...
export function DreamsignBazaarSiteScreenAdapter({ siteId }: { siteId: string }) {
  ...
  const handleClose = useCallback(() => {
    if (site === null) return;
    logEvent("site_completed", { siteType: "DreamsignMarket", outcome: "left", ui: "tango" });
