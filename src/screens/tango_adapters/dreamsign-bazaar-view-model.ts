// Pure view-model builder for Amunet's Tango Dreamsign Bazaar.
...
} from "../../tango/screens/DreamsignBazaarSiteScreen";
...
/** Build the complete Tango Dreamsign Bazaar view-model. */
