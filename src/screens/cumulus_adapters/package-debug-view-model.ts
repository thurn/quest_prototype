...
export function buildPackageDebugView(draftState: DraftState | null, cardDatabase: ReadonlyMap<number, CardData>, resolvedPackage: ResolvedDreamcallerPackage | null, remainingDreamsignPool: readonly string[], dreamsignTemplates: readonly DreamsignTemplate[]): PackageDebugView {
  ...
  return {
    ...
    dreamcaller: pkg?.dreamcallerName ?? null,
