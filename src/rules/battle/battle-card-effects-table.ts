...
import {
  ...
  supportingReserveSlots,
} from "../../battle/engine/support";
...
export const BATTLE_EFFECT_FIXTURE_CARD_ID =
  "00000000-0000-4000-8000-000000000101";
export const BATTLE_EFFECT_PROMPT_FIXTURE_CARD_ID =
  "00000000-0000-4000-8000-000000000102";
export const BATTLE_EFFECT_DISSOLVE_SUPPORT_FIXTURE_CARD_ID =
 ...
 */
export const BATTLE_TRIGGERED_EFFECTS: Record<
  string,
  BattleTriggeredEffectScript
> = {
  ...
  "647f5150-b2e0-424b-9480-27557642524e": {
    id: asCardId("647f5150-b2e0-424b-9480-27557642524e"),
    textHash: "153cdaf2",
    triggers: {
  ...
  "a526fa7b-5cef-4da9-a3f2-27ee0bd9b481": {
    ...
    triggers: {
      dissolved: [
        {
          kind: "edits",
          build: (ctx) => [{ kind: "DRAW_CARD", side: ctx.side }],
        },
      ],
      abandoned: [
        {
  ...
  "5ab11bef-5dcd-49f5-be49-ae2ccde76e70": {
    id: asCardId("5ab11bef-5dcd-49f5-be49-ae2ccde76e70"),
    textHash: "42ad9866",
    triggers: {},
  },
      ...
      played: [
        {
          ...
          build: (ctx) => {
            ...
            const instance =
              target === undefined
                ? undefined
                : ctx.state.cardInstances[target];
            ...
            return [
              {
                ...
                battleCardId: target,
                destination: {
                  side: ctx.side === "player" ? "enemy" : "player",
                  zone: "void",
                },
              },
            ];
  ...
  "910b4cf9-dec7-4e03-af4f-7d5ae342eeba": {
    id: asCardId("910b4cf9-dec7-4e03-af4f-7d5ae342eeba"),
    textHash: "469120a4",
    triggers: {
      played: [
        {
          ...
          prompt: {
            kind: "pick-cards",
            label: builtInBattlePromptRef("discover-character"),
            count: 1,
            optional: false,
  ...
  "944e15d2-d680-4ebe-8d18-36826f4b1535": {
    id: asCardId("944e15d2-d680-4ebe-8d18-36826f4b1535"),
    textHash: "03e76b70",
    triggers: {
      played: [
        {
  ...
  [BATTLE_EFFECT_FIXTURE_CARD_ID]: {
    id: asCardId(BATTLE_EFFECT_FIXTURE_CARD_ID),
    triggers: {
  ...
  [BATTLE_EFFECT_PROMPT_FIXTURE_CARD_ID]: {
    id: asCardId(BATTLE_EFFECT_PROMPT_FIXTURE_CARD_ID),
    triggers: {
      materialized: [
        {
          kind: "prompt",
  ...
  [BATTLE_EFFECT_DISSOLVE_SUPPORT_FIXTURE_CARD_ID]: {
    id: asCardId(BATTLE_EFFECT_DISSOLVE_SUPPORT_FIXTURE_CARD_ID),
    triggers: {
...
export function battleTriggerScriptId(
  cardId: CardId,
  trigger: BattleScriptTrigger,
): BattleEffectScriptId {
  return asBattleEffectScriptId(`${cardId}${TRIGGER_ID_SEPARATOR}${trigger}`);
}
...
export function selectBattleTriggeredEffectSteps(
  ...
  return script.triggers[trigger] === undefined
    ? null
...
export const BATTLE_CARD_EFFECTS: Record<string, BattleCardEffectScript> = {
  "4e3c04a9-1cdd-468a-b42a-40157ed9c9d6": {
    id: asCardId("4e3c04a9-1cdd-468a-b42a-40157ed9c9d6"),
    trigger: "support",
    textHash: "c72e97a0",
    support: {
      bonus: () => 1,
  ...
  "56411ed4-bda9-4fdf-82e5-b5492de67039": {
    id: asCardId("56411ed4-bda9-4fdf-82e5-b5492de67039"),
    trigger: "support",
    textHash: "84f5be41",
    support: {
  ...
  "1268a899-b209-46bb-bce4-6def1dcd0404": {
    id: asCardId("1268a899-b209-46bb-bce4-6def1dcd0404"),
    trigger: "support",
    textHash: "04484014",
    support: { bonus: () => 2 },
  },
  ...
  "6497d8b1-85b8-486d-99e2-5c141486d508": {
    id: asCardId("6497d8b1-85b8-486d-99e2-5c141486d508"),
    trigger: "support",
    textHash: "a2c043a8",
    support: {
      bonus: () => 3,
  ...
  "8c9ef6a8-d93e-4149-a965-0bdbe2acf6bd": {
    id: asCardId("8c9ef6a8-d93e-4149-a965-0bdbe2acf6bd"),
    trigger: "support",
    textHash: "b82fe41f",
    support: { bonus: () => 3 },
  },
  "c61c8b29-6911-4bbf-b1c4-0c18b22ed33f": {
    id: asCardId("c61c8b29-6911-4bbf-b1c4-0c18b22ed33f"),
    trigger: "support",
    textHash: "b027ad8e",
    support: { bonus: () => 2 },
  },
  "c8579b20-95ff-4b1d-b4c6-6bd049fc4760": {
    id: asCardId("c8579b20-95ff-4b1d-b4c6-6bd049fc4760"),
    trigger: "support",
    textHash: "7415a86e",
    support: {
      bonus: () => 2,
...
export function collectAutomationHashDrift(
  ...
  for (const [id, script] of Object.entries(BATTLE_TRIGGERED_EFFECTS)) {
    if (script.textHash === undefined || BATTLE_CARD_EFFECTS[id] !== undefined)
      continue;
    const cardId = asCardId(id);
    const text = cardsById.get(cardId);
    const actual = text === undefined ? null : fnv1aHex(text);
  ...
  if (enabled) {
    for (const side of sides) {
      ...
      for (const backSlot of rankSlotIds(state.sides[side].backRank)) {
        ...
        const script = selectBattleCardEffectScript(
          supporter.definition.cardId,
        );
        ...
        for (const frontSlot of supportedDeploySlots(backSlot)) {
          ...
          if (
            script.support.applies !== undefined &&
            !script.support.applies(ally, ctx)
          ) {
            continue;
          }
          targets.set(
            allyId,
            (targets.get(allyId) ?? 0) + script.support.bonus(ctx),
          );
        }
      }
    }
    ...
    for (const side of sides) {
      for (const frontSlot of rankSlotIds(state.sides[side].frontRank)) {
        ...
        if (
          recipientId === null ||
          state.cardInstances[recipientId]?.definition.cardId !==
            "5ab11bef-5dcd-49f5-be49-ae2ccde76e70"
        )
          continue;
        const occupied = supportingReserveSlots(frontSlot).filter(
          (slot) => state.sides[side].backRank[slot] !== null,
        ).length;
        targets.set(
          recipientId,
          (targets.get(recipientId) ?? 0) + occupied * 2,
        );
      }
    }
  }
...
function sampleDiscoverCharacters(ctx: StepContext): BattleCardId[] {
  const candidates = ctx.state.sides[ctx.side].deck.filter(
    (battleCardId) =>
      ctx.state.cardInstances[battleCardId]?.definition.battleCardKind ===
      "character",
  );
...
function resolveDiscoverChoice(
  chosenIds: BattleCardId[],
  ctx: StepContext,
): BattleDebugEdit[] {
  const chosen = chosenIds[0];
  if (chosen === undefined) return [];
  const remaining = ctx.state.sides[ctx.side].deck.filter(
    (id) => id !== chosen,
  );
