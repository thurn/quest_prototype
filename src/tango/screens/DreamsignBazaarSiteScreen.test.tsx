...
describe("DreamsignBazaarSiteScreen", () => {
  it("shows Amunet, a compact two-column shelf, prices, and the restock action on mobile", () => {
    ...
    expect(
      container.querySelector('[data-testid="tango-dreamsign-bazaar-speech-bubble"]')
        ?.textContent,
    ...
    expect(
      container.querySelectorAll('[data-testid^="tango-dreamsign-bazaar-offer-"]'),
    ).toHaveLength(3);
    expect(
    ...
    act(() => {
      container
        .querySelector<HTMLElement>(
          '[data-testid="tango-dreamsign-bazaar-offer-dreamsign-offer-0"]',
        )
        ?.click();
      container
        .querySelector<HTMLElement>(
          '[data-testid="tango-dreamsign-bazaar-offer-dreamsign-offer-2"]',
        )
        ?.click();
      container
  ...
  it("renders cap replacement choices above the shared screen", () => {
    ...
    act(() => {
      container
        .querySelector<HTMLElement>(
          '[data-testid="tango-dreamsign-bazaar-purge-1"]',
        )
        ?.click();
    });
