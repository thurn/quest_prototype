// DreamsignBazaarSiteScreen — Amunet's Tango Dreamsign market. It uses the
...
export function DreamsignBazaarSiteScreen({
  ...
  return (
    <GuideGallerySiteLayout
      ...
      scene={view.scene}
      guide={view.guide}
      screenTestId="tango-dreamsign-bazaar-site-screen"
      guideArtTestId="tango-dreamsign-bazaar-guide-art"
      speechAnchorTestId="tango-dreamsign-bazaar-speech-anchor"
      speechBubbleTestId="tango-dreamsign-bazaar-speech-bubble"
  ...
  return (
    ...
    >
      <DreamsignGalleryPanel
        ...
        testId="tango-dreamsign-bazaar-gallery"
        onClose={onClose}
      ...
      {purchaseTravels.map((travel) => (
        <motion.div
          key={travel.key}
          data-testid="tango-dreamsign-bazaar-purchase-travel"
        ...
        >
          {purge.currentDreamsigns.map((dreamsign, index) => (
            <Dreamsign
              ...
              testid={`tango-dreamsign-bazaar-purge-${String(index)}`}
            />
          ))}
        </div>
