...
function GlowIconDemo(args: Record<string, unknown>) {
  ...
  const color = (args.color ?? SPARK_ICON_COLOR) as TangoColor;
...
<GlowIcon iconClass={SPARK_ICON_CLASS} color={SPARK_ICON_COLOR} size="44px" shadow title="Spark" />`,
    },
    {
      ...
      code: `import { GlowIcon, ENERGY_ICON_CLASS, ENERGY_ICON_COLOR } from "src/tango/components/controls/GlowIcon";
...
<GlowIcon iconClass={ENERGY_ICON_CLASS} color={ENERGY_ICON_COLOR} />`,
    },
    {
      ...
      code: `import { GlowIcon, BOLT_ICON_CLASS } from "src/tango/components/controls/GlowIcon";
