...
export const transfigurationFormButtonDemo: TangoComponent = {
  ...
  usage: [
    {
      ...
      code: `import { TransfigurationFormButton } from "src/tango/components/controls/TransfigurationFormButton";
