// Docgen fixture exercised ONLY by generate-tango-metadata.test.mjs's
...
// the component (`isComponentName` in generate-tango-metadata.mjs).
//
...
// leaks into the committed tango-metadata.json.
