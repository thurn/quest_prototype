...
/** Mobile shows a generous empty formation while keeping the rules-level 3/2 floor. */
export const MOBILE_BATTLE_MIN_BACK_RANK_SLOTS = 6;
export const MOBILE_BATTLE_MIN_FRONT_RANK_SLOTS = 5;
