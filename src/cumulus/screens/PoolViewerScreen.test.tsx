...
describe("PoolViewerScreen", () => {
  it("uses Cumulus controls and reports stable source/filter/card ids", () => {
    ...
    expect(
      container.querySelector('[data-testid="pool-viewer-gallery"]'),
    ).not.toBeNull();
    const searchInput = container.querySelector(
      '[data-testid="pool-viewer-search"]',
    );
    const localizedSinkValues = [
      container.querySelector("h2")?.textContent,
      container
        .querySelector('[data-testid="pool-viewer-close"]')
