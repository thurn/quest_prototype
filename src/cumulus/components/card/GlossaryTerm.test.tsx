...
const FIXTURE = vi.hoisted(() => ({ term: "Lumenstep", definition: "Move through a fixed semantic fixture." }));

vi.mock("../../../data/glossary", () => ({
  GLOSSARY: [FIXTURE],
  lookupGlossaryTerm: (term: string) => term.toLocaleLowerCase() === FIXTURE.term.toLocaleLowerCase() ? FIXTURE : undefined,
}));
