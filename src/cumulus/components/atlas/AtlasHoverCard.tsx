...
// node on the Cumulus desktop atlas. The atlas-specific data shape lives here,
 ...
 * by the shared root reveal coordinator exactly like every other Cumulus reveal.
 */
