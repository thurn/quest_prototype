...
describe("TideSelectionButton", () => {
  it.each([
    ...
    act(() => root.render(<CumulusRoot><TideSelectionButton id="Tide-Case-A" label="Fixed Tide" description="Fixed description." selectionRole={selectionRole} active={false} joined onActivate={onActivate} /></CumulusRoot>));
