...
describe("ResourceChip semantic source", () => {
  it("derives an icon InfoCard from resource domain data", () => {
    ...
    act(() => root.render(<CumulusRoot><ResourceChip kind="essence" value={120} entity={{ id: "quest-start-caller", label: "Starting Essence", description: "Spend it during this run." }} /></CumulusRoot>));
