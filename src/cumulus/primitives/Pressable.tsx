// Pressable — the ONE press-feedback primitive for Cumulus.
//
// Every interactive Cumulus control routes its feedback through this one
...
// touch-only to Cumulus's input-adaptive pointer model: the press state is
