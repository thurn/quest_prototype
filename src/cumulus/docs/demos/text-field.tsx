...
function Demo({ label = "Search cards", placeholder = "Type a name…" }: { label?: string; placeholder?: string }) { const [value, setValue] = useState(""); return <TextField label={label} kind="search" value={value} placeholder={placeholder} onChange={setValue} />; }
