// Registry demo entry for Pressable, the first real Cumulus component import.
//
// This file establishes the reusable per-component "import recipe": a
// `CumulusComponent` entry lives in its own `demos/<id>.tsx` file (JSX needs a
...
export const pressableDemo: CumulusComponent = {
  id: "pressable",
  title: "Pressable",
  blurb:
  ...
  callout: "Reach for a higher-level component first.",
  details: [
    "Pressable is a low-level building block — before wrapping raw markup in it, look for an existing Cumulus component (GlassButton, TideDisc, SegmentedControl, SiteNode, …) that already bakes in the press feedback. Use Pressable only when you're building a genuinely new interactive surface no component covers.",
  ],
  group: "Primitives",
  docName: "Pressable",
  Component: Pressable,
