...
export const cardOrderEditorDemo: CumulusComponent = { id: "card-order-editor", title: "CardOrderEditor", blurb: "An identity-safe top-to-bottom card ordering control for the battle deck-order workflow.", group: "Components", docName: "CardOrderEditor", Component: Demo, usage: [{ code: `<CardOrderEditor label="Deck order" items={cards} onOrderChange={setOrderedCardIds} />` }], demo: { defaultArgs: { label: "Deck order" } } };
