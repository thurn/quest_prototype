...
export const infoCardDemo: CumulusComponent = {
  ...
  callout:
    "InfoCard supplies strict visual content variants. Named semantic components register that content with the root coordinator, which normally places desktop hover reveals beside their target on the left or right and owns mobile safe-area bounds and touch clearance. Dream Augury OfferTile is the single one-off exception to that desktop rule: its body-only InfoCard centers above its respective offer so the two choices remain visually legible. This exception is specific to Dream Augury and is not a reusable placement pattern for other Cumulus surfaces.",
  group: "Components",
  docName: "InfoCard",
  Component: InfoCard,
  usage: [
