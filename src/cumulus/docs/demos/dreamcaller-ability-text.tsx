...
export const dreamcallerAbilityTextDemo: CumulusComponent = {
  ...
  blurb:
    "The complete Dreamcaller rules-text source: hovering, focusing, or touch-holding anywhere in the ability reveals InfoCards for every defined term in reading order.",
  group: "Components",
