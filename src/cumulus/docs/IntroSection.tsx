// IntroSection — the Introduction / Design Philosophy section of the /cumulus
...
/**
 * The Introduction / Design Philosophy section of the /cumulus overview.
