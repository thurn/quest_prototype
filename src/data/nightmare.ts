...
export const NIGHTMARE_CARD_ID: CardId = asCardId(CARD_ROLE_DATA.nightmare.cardId);
export const NIGHTMARE_CARD_NUMBER = CARD_ROLE_DATA.nightmare.historicalCardNumber;
