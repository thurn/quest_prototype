...
describe("loadTutorialCards", () => {
  it("loads the canonical card data without partitioning it by tutorial owner", async () => {
    const other = { id: testCardId("other-card"), cardNumber: 519 } as CardData;
    const opponent = {
    ...
    const finalWitness = {
      id: testCardId("a526fa7b-5cef-4da9-a3f2-27ee0bd9b481"),
    } as CardData;
    const nocturneStrummer = {
      id: testCardId("5a980eff-6ec7-44d8-9977-b98e66bbc2c8"),
    } as CardData;
    const flashpointDetonation = {
      id: testCardId("4408b942-09a0-4f4e-a403-10c708c6e3c5"),
    } as CardData;
    const glimpseOfWhatWas = {
      id: testCardId("2162742c-09d0-4e62-ae49-0f8f79b45adc"),
    } as CardData;
    const dreamwell = {
