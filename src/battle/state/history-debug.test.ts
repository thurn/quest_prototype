  ...
  return [
    ...
    },
    {
      ...
      buildState: () => {
        ...
        fresh.state.sides.player.backRank.B0 = characterId;
        return fresh;
      },
      command: {
        id: "DEBUG_EDIT",
    ...
    },
    {
      ...
      buildState: () => {
        ...
        fresh.state.sides.player.frontRank.F0 = a;
        fresh.state.sides.player.backRank.B0 = b;
        return fresh;
      },
      command: {
        id: "DEBUG_EDIT",
        edit: {
          ...
          target: { side: "player", zone: "backRank", slotId: "B0" },
        },
      },
    },
    {
    ...
    },
    {
      ...
      buildState: () => {
        ...
        fresh.state.sides.player.backRank.B1 = character;
        return fresh;
      },
      command: {
        id: "DEBUG_EDIT",
