...
if (
  !EXPLORATION_PREDICATES.every(
    ({ value }) => value === "" || REWARD_CARD_PREDICATES.includes(value),
  )
) {
  throw new Error(
    "Exploration predicate options are out of sync with reward selection",
  );
}
...
export const EXPLORATION_EFFECT_SCHEMAS = [
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "dreamsign-match"],
    fields: [
      {
        key: "offerCount",
        label: "Offer count",
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "transfiguration-value"],
    fields: [
      {
        key: "predicate",
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "purge-misfit"],
    fields: [
      {
        key: "predicate",
        label: "Card predicate",
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "card-fit", "card-bundle"],
    fields: [
      {
        key: "predicate",
        label: "Card predicate",
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "card-fit", "card-fit-quality"],
    fields: [
      {
        key: "predicate",
        label: "Card predicate",
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "deck-entry-centrality"],
    fields: [
      {
        key: "deckTarget",
        label: "Deck target",
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "card-fit-quality"],
    fields: [
      {
        key: "predicate",
  ...
  },
  {
    ...
    allowedSelectionPolicyIds: ["uniform", "duplicate-value"],
    fields: [
      {
        key: "deckTarget",
        label: "Deck target",
...
for (const definition of EXPLORATION_EFFECT_SCHEMAS) {
  if (!isRewardMechanicId(definition.canonicalMechanicId)) {
    throw new Error(
      `Unknown Exploration mechanic ${definition.canonicalMechanicId}`,
    );
  }
  if (definition.defaultSelectionPolicyId !== undefined) {
    if (!isRewardSelectionPolicyId(definition.defaultSelectionPolicyId)) {
      throw new Error(
        `Unknown Exploration selection policy ${definition.defaultSelectionPolicyId}`,
      );
    }
    for (const policyId of definition.allowedSelectionPolicyIds) {
      if (
        !isRewardSelectionPolicyId(policyId) ||
        !mechanicSupportsPolicy(definition.canonicalMechanicId, policyId)
      ) {
        throw new Error(
          `Exploration policy ${policyId} is incompatible with ${definition.canonicalMechanicId}`,
        );
      }
    }
  }
