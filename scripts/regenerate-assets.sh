...
#   5. setup-assets         copy the fresh artifacts into public/
#   6. check-tides4          confirm the tides4 freshness gate passes
#
...
step "1/6  setup-assets — build public/ inputs from source"
node scripts/setup-assets.mjs

step "2/6  bake-merchant-corpus — data/merchant_corpus.json"
node scripts/bake-merchant-corpus.mjs

step "3/6  bake-affinity-corpus — data/affinity_corpus.jsonc"
node scripts/bake-affinity-corpus.mjs

step "4/6  bake-tides4 — data/tides4.jsonc + markdown"
node scripts/bake-tides4.mjs

step "5/6  setup-assets — copy fresh artifacts into public/"
node scripts/setup-assets.mjs

step "6/6  check-tides4 — verify the freshness gate"
