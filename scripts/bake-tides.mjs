...
const HEADER = `// data/tides.jsonc — the 32 committed tide decks the \`tides\` draft-pool variant
...
function renderMarkdown(json, dreamcallers, tideStats) {
...
function run() {
  ...
  writeFileSync(resolve(ROOT, docRel), renderMarkdown(json, dreamcallers, tideStats) + "\n");
