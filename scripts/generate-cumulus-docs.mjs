...
//   - src/cumulus/primitives/cumulus-tokens.css   design tokens; only the semantic
//                                             tier is published (--primitive-*
//                                             is internal to cumulus and filtered)
//
 ...
 * are cumulus-internal raw values, not part of the caller-facing vocabulary).
 */
