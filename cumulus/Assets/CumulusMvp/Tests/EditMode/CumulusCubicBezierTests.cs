...
{
    public sealed class CumulusCubicBezierTests
    {
        ...
        {
            Assert.That(CumulusCubicBezier.Evaluate(0f, Control1, Control2), Is.EqualTo(0f));
            Assert.That(CumulusCubicBezier.Evaluate(1f, Control1, Control2), Is.EqualTo(1f));
        }
        ...
        public void Evaluate_IsFiniteMonotonicAndDeterministic()
        {
            ...
            for (int sample = 0; sample <= 100; sample++)
            {
                ...
                float first = CumulusCubicBezier.Evaluate(progress, Control1, Control2);
                float second = CumulusCubicBezier.Evaluate(progress, Control1, Control2);
