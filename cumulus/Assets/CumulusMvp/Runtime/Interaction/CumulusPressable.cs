...
namespace CumulusMvp.Interaction
{
    ...
    public sealed class CumulusPressable : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (visual == null)
            {
                Debug.LogError("CumulusPressable requires an assigned visual child.", this);
                enabled = false;
                return;
            }
            ...
            {
                Debug.LogError("CumulusPressable visual must be a child of the stable collider root.", this);
                enabled = false;
                return;
            }
        ...
        public bool EndPress(bool pointerStillOver)
        {
            ...
            Debug.Log($"CumulusPressable activated: {semanticId}", this);
            activated.Invoke();
            return true;
        }
