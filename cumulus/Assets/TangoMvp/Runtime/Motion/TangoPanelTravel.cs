...
namespace TangoMvp.Motion
{
    [DisallowMultipleComponent]
    public sealed class TangoPanelTravel : MonoBehaviour
    {
        ...
        public void ToggleDestination()
        {
            if (sourceAnchor == null || destinationAnchor == null)
            {
                Debug.LogError("TangoPanelTravel requires source and destination anchors.", this);
                return;
            }
