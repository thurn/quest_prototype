...
{
    public enum TangoVerificationRegion
    {
        LiveGlassA,
        LiveGlassB,
        UncoveredPattern,
    ...
    public sealed class TangoVerificationMarkers : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log(
                $"Tango glass lab initialized: unity={Application.unityVersion}, " +
                $"urp={urpVersion}, mode=live-shared-blur",
                this);
        }

        public Rect GetViewportRegion(TangoVerificationRegion region, Camera camera)
        {
            if (camera == null)
            {
        ...
        private Transform Resolve(TangoVerificationRegion region)
        {
            switch (region)
            {
                case TangoVerificationRegion.LiveGlassA:
                    return liveGlassA;
                case TangoVerificationRegion.LiveGlassB:
                    return liveGlassB;
                case TangoVerificationRegion.UncoveredPattern:
                    return uncoveredPattern;
                case TangoVerificationRegion.OnGlassButton:
                    return onGlassButton;
                case TangoVerificationRegion.SolidBevel:
                    return solidBevel;
                case TangoVerificationRegion.FrameShadowReceiver:
                    return frameShadowReceiver;
                case TangoVerificationRegion.PrimaryLabel:
                    return primaryLabel;
                default:
