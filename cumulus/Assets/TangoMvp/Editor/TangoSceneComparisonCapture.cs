...
namespace TangoMvp.Editor
{
    ...
    public static class TangoSceneComparisonCapture
    {
        ...
        private static void Capture(Camera camera, int width, int height, string outputPath)
        {
            ...
            {
                name = "Tango Scene Comparison Capture",
                antiAliasing = 1,
            };
            ...
            try
            {
                ...
                Debug.Log($"TANGO_SCENE_COMPARISON_CAPTURE:{absolutePath}:{width}x{height}");
            }
            finally
            {
