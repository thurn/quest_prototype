...
{
    public static class TangoMvpBatchVerification
    {
        private const string ArtifactRelativePath = "Artifacts/TangoMvpVerification";
        private const string PlayerRelativePath = "Builds/TangoMvpVerification/CumulusTangoMvp.app";
        ...
        public static void InspectShadersAndBuildPlayer()
        {
            ...
            if (errorCount != 0)
            {
                Debug.LogError($"Tango MVP shader inspection found {errorCount} error(s).");
            ...
            string[] enabledScenes = EditorBuildSettings.scenes
                ...
                .ToArray();
            if (enabledScenes.Length != 1 || enabledScenes[0] != "Assets/Scenes/TangoGlassLab.unity")
            {
                ...
                Debug.LogError("Tango MVP build settings must contain exactly the enabled TangoGlassLab scene.");
            ...
            {
                Debug.LogError($"Tango MVP standalone build failed: {summary.result}.");
                EditorApplication.Exit(22);
            }
        }
